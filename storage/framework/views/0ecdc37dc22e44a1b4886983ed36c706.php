            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center fw-bold"><?php echo e(number_format($item->total)); ?></td>
                        <td class="text-center">
                            ...
                            <form action="<?php echo e(route('admin.items.destroy', $item->id)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?> 
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="" disabled <?php echo e(old('category_id') ? '' : 'selected'); ?>>Select Category</option>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
