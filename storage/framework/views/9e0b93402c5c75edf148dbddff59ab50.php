    ...
    <aside class="sidebar" id="sidebar">
        <div class="p-4 pt-5">
            <ul class="nav flex-column gap-2">
                <li>
                    <a href="/<?php echo e(auth()->user()->role); ?>/dashboard"
                        class="nav-link-custom d-flex align-items-center <?php echo e(request()->is(auth()->user()->role . '/dashboard') ? 'active' : ''); ?>">
                ...
                <?php if(auth()->user()->role === 'admin'): ?>
                    <li>
                        <a href="/admin/categories"
                            class="nav-link-custom d-flex align-items-center <?php echo e(request()->is('admin/categories') ? 'active' : ''); ?>">
                ...
                <?php else: ?>
                    <li>
                        <a href="/operator/lendings"
                            class="nav-link-custom d-flex align-items-center <?php echo e(request()->is('operator/lendings') ? 'active' : ''); ?>">
                ...
                <li>
                    <a href="/<?php echo e(auth()->user()->role); ?>/items"
                        class="nav-link-custom d-flex align-items-center <?php echo e(request()->is(auth()->user()->role . '/items') ? 'active' : ''); ?>">
                ...
                <li class="nav-item dropdown">
                    <a href="#"
                        class="nav-link-custom d-flex align-items-center dropdown-toggle <?php echo e(request()->is(auth()->user()->role . '/users*') ? 'active' : ''); ?>"
                    ...
                    <ul class="dropdown-menu px-2 py-2">
                        ...
                        <?php if(auth()->user()->role == 'admin'): ?>
                            <li>
                                <a class="dropdown-item <?php echo e(request()->is('admin/users-admin') ? 'active' : ''); ?>"
                            ...
                            <li>
                                <a class="dropdown-item <?php echo e(request()->is('admin/users-user') ? 'active' : ''); ?>"
                        ...
                        <?php elseif(auth()->user()->role == 'operator'): ?>
                            <li>
                                <a class="dropdown-item <?php echo e(request()->is('operator/users/edit') ? 'active' : ''); ?>"
...
<?php /**PATH C:\Users\Alya.Pratiwi\laragon\www\12309515---Alya-Nurcahya---Inventaris\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>