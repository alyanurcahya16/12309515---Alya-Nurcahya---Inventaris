                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @endphp
                            <span class="badge {{ $badgeClass }}">{{ $category->division_pj }}</span>
                        </td>
                        <td class="text-center fw-bold">{{ number_format($category->items->count()) }}</td>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="division_pj" 
                                                    class="form-select @error('division_pj') is-invalid @enderror" 
                                                    required>
                                                <option value="Sarpras" {{ old('division_pj', $category->division_pj) == 'Sarpras' ? 'selected' : '' }}>Sarpras</option>
                                                <option value="Tata Usaha" {{ old('division_pj', $category->division_pj) == 'Tata Usaha' ? 'selected' : '' }}>Tata Usaha</option>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="division_pj" 
                                class="form-select @error('division_pj') is-invalid @enderror" 
                                required>
                            <option value="" disabled {{ old('division_pj') ? '' : 'selected' }}>Select Division</option>
...
<script>
    ...
    @if($errors->any())
        @if(session('edit_fail_id'))
            var myModal = new bootstrap.Modal(document.getElementById('editModal{{ session('edit_fail_id') }}'));
        @else
