    ...
    @if (session('generated_password'))
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Password Generated!</strong> Login Credential: <code
                class="bg-dark text-warning px-2 py-1 rounded">{{ session('generated_password') }}</code>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.users.export.pdf') }}" class="btn btn-danger btn-sm">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}"
                                    class="form-control @error('name') is-invalid @enderror" placeholder="Admin Name"
                                    required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
        ...
        @if ($errors->any())
            @if (session('edit_user_fail_id'))
                var myModal = new bootstrap.Modal(document.getElementById(
                    'editUserModal{{ session('edit_user_fail_id') }}'));
            @else
