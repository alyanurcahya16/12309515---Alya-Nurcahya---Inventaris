        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <div>
                    ...
                    <h2 class="fw-bold mt-1 mb-0">{{ number_format($stats['total_items']) }}</h2>
                    <div class="mt-2">
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <div>
                    ...
                    <h2 class="fw-bold mt-1 mb-0">{{ number_format($stats['total_qty']) }}</h2>
                    <div class="mt-2">
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <div>
                    ...
                    <h2 class="fw-bold mt-1 mb-0">{{ number_format($stats['categories']) }}</h2>
                    <div class="mt-2">
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body">
                ...
                <div>
                    ...
                    <h2 class="fw-bold mt-1 mb-0">{{ number_format($stats['users'] ?? 0) }}</h2>
                    <div class="mt-2">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3 border-0">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.items.index') }}" class="text-decoration-none small">View All →</a>
                </div>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('admin.categories.index') }}" class="btn btn-outline-success text-start py-3">
                        <svg width="20" height="20" fill="none" stroke="currentColor" class="me-2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                        </svg>
                        Manage Categories
                    </a>
                    <a href="{{ route('admin.users.index') }}" class="btn btn-outline-info text-start py-3">
                        <svg width="20" height="20" fill="none" stroke="currentColor" class="me-2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                        </svg>
                        Manage Users
