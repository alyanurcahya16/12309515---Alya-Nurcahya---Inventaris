...
<head>
    ...
    <title>@yield('page-title', 'Dashboard') - Inventaris</title>
        ...
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="d-none d-sm-flex flex-column text-end me-2">
                    <span class="fw-semibold text-dark lh-1">{{ $user->name }}</span>
                ...
                <div class="dropdown">
                    <button class="btn btn-link p-0" type="button" data-bs-toggle="dropdown">
                        <img class="avatar"
                            src="https://ui-avatars.com/api/?name={{ urlencode($user->name ?? 'U') }}&background=0284c7&color=fff&bold=true">
                    </button>
